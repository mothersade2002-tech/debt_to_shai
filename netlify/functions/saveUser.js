...
exports.handler = async (event) => {
  ...
  try{
    ...
    await pool.query(`INSERT INTO user_accounts (email, code, height, weight, createdat, debt, title) VALUES ($1,$2,$3,$4,$5,$6,$7) ON CONFLICT (code) DO NOTHING`, [email, code, height, weight, createdAt, debt, 'worm']);
